...
def generate_all_pyi(outpath, options):
    ...
    # now we can import
    global PySide2, PySide2Ads, inspect, typing, HintingEnumerator, build_brace_pattern
    import PySide2
    import PySide2Ads
    import PySide2Ads.QtAds.ads
    sys.modules['ads'] = sys.modules['PySide2Ads.QtAds.ads']
    sys.modules['ads'].__name__ = 'ads'
    ...
    outpath = outpath or os.path.dirname(PySide2Ads.__file__)
    for mod_name in options.modules:
        import_name = "PySide2Ads." + mod_name
